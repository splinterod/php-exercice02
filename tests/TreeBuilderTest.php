...
//        ce test est valable pour un niveau de hierarchie max de 2
...
/*          Niveau hiearchique 1: on récupére l'index (numéro de chapitre) et on concatène avec le titre du chapitre
...
/*                  Ajoute au tableau chaque numéro de chapitre (en reprenant aussi le numéro index niveau 1) et
                    on concatène avec le titre du sous chapitre  en respectant le format "<number><dot><number><dot> NOM CHAPITRE"*/
                    array_push($origineTable, $chapter['index'] . "." . $subChapter['index'] . ". ". $subChapter['title']);
                }
            }
        }
